...
<body>
    ...
    <form method="post" action="accueil-traitement-2.php">
        <table class='table table-striped table-bordered'>
            <thead><tr><th>ID</th><th>Titre</th><th>Image</th><th>Image 2</th><th>Video</th><th>Action</th></tr></thead>
            <tbody>
                <?php
                    ...
                    while ($row = $resultat->fetch_assoc()) {
                        ...
                        echo "<td><textarea name='img[$index]'>" . $row["img"] . "</textarea></td>";
                        echo "<td><textarea name='img2[$index]'>" . $row["img2"] . "</textarea></td>";
                        echo "<td><textarea name='video[$index]'>" . $row["video"] . "</textarea></td>";
