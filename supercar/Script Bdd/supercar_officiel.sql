...
OUT `p_disponible` BOOLEAN)   BEGIN
    ...
    FROM demande_essai
    WHERE nom_modele COLLATE utf8mb4_general_ci = p_nom_modele
    AND date_demande = p_date_demande
    AND heure_arriver COLLATE utf8mb4_general_ci = p_heure_arriver
    AND (etat = 'en attente' OR etat = 'confirmé');
    
    IF nb_demandes = 0 THEN
        SET p_disponible = 1;  -- TRUE en MySQL
    ELSE
        SET p_disponible = 0;  -- FALSE en MySQL
    END IF;
END$$
...
(31, 'Bouzy', 'Bouzy', 'Bouzy', 'bouzy@gmail.com', 'WExUdzF4TnBpMVdOWmFEcCs2Umg4Zz09Ojo4RCs2MHN1SXZhbEtBNjVMTnJSTzdnPT0=', '2025-04-17');
...
(59, '2025-04-18', 'Steve', 'Audi Q8', '12:00', 'en attente'),
(60, '2025-04-18', 'Bouzy', 'Audi RS3', '12:00', 'en attente');
...
CREATE TABLE IF NOT EXISTS `historique_connexion` (
  ...
  `nom_utilisateur` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `type_action` enum('connexion','deconnexion') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `historique_connexion` (`id_historique`, `nom_utilisateur`, `type_action`, `date_heure`) VALUES
(11, 'Steve', 'connexion', '2025-04-17 20:37:57'),
(12, 'Steve', 'connexion', '2025-04-17 20:44:05'),
(13, 'Steve', 'deconnexion', '2025-04-17 20:44:49'),
(14, 'Bouzy', 'connexion', '2025-04-17 20:45:10'),
(15, 'Bouzy', 'connexion', '2025-04-17 20:45:25');
