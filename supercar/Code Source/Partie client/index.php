                ...
                <div class="col-md-5 text-center">
                    <?php
                        ...
                        if ($result !== null && $result->num_rows > 0) {
                            // Affiche les données de chaque ligne
                            while ($row = $result->fetch_assoc()) {
                                echo "<h3 align='center'><strong>" . $row["titre"] . "</strong></h3>";
                            }
                        } else {
                            echo "0 résultats";
                        }
                ...
                <div class="col-md-5 text-center">
                    <?php
                        ...
                        if ($result !== null && $result->num_rows > 0) {
                            // Affiche les données de chaque ligne
                            while ($row = $result->fetch_assoc()) {
                                echo "<p align='center'>" . $row["texte"] . "</p>";
                            }
                        } else {
                            echo "0 résultats";
                        }
...
<!-- TEXTE DE RENDEZ VOUS -->
                        ...
                        <a href="pages/contact/contactez-nous.php">
                            <?php
                                ...
                                if ($result !== null && $result->num_rows > 0) {
                                    // Affiche les données de chaque ligne
                                    while ($row = $result->fetch_assoc()) {
                                        echo "<p align='center'><img src='".$row["img"]."' class='zoomable-image' style='width: 80%; height: auto;'></p>" ;
                                    }
                                } else {
                                    echo "0 résultats";
                                }
    ...
    <?php
    // Fermer la connexion à la base de données après toutes les requêtes
    $connexion->close();
    ?>
