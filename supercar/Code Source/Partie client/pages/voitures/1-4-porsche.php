...
<head>
    ...
    <style>
        ...
        .hero-section {
            position: relative;
            height: 60vh;
            background-image: url('https://pictures.porsche.com/rtt/iris?COSY-EU-100-1711coMvsi60AAt5FwcmBEgA4qP8iBUDxPE3Cb9pNXABuN9dMGF4tl3U0%25z8rMHIspbWvanYb%255y%25oq%25vSTmjMXD4qAZeoNBPUSfUx4RmHlCgI7Zl2dioCLafQDcFG8oXYnfurn2L5yPewFo0CvNzxu5uGXoq1qdEr6FObiwTBsN5xMq2dioC1ivQD9AzXCKuAIKyDUZYOOt5FTmnEBc6XdGo7');
...
<body>
    ...
    <section class="hero-section">
        <div class="hero-content">
            <h1>"Il n'y a pas de substitut"</h1>
            <p>Découvrez notre collection de Porsche</p>
        </div>
    </section>
    ...
    <section class="logo-section">
        <a href="1-0-voitures.php">
            <img src="icone_marque/icons8-porsche-48.png" alt="Porsche Logo">
        </a>
    </section>
    ...
    <section class="cards-section">
        <div class="container">
            <div class="row g-4">
                ...
                $query = "SELECT * FROM voitures WHERE marque='PORSCHE'";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo '<p class="text-muted">Aucune voiture Porsche n\'a été trouvée.</p>';
                    echo '</div>';
                }
