...
<body>
    ...
    <section class="hero-section">
        <div class="hero-content">
            <h1>"Avance par la technologie"</h1>
            <p>Découvrez notre collection d'Audi</p>
        </div>
    </section>
    ...
    <section class="logo-section">
        <a href="1-0-voitures.php">
            <img src="icone_marque/icons8-audi-50.png" alt="Audi Logo">
        </a>
    </section>
        ...
        <div class="container">
            <div class="row g-4">
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo '<p class="text-muted">Aucune voiture Audi n\'a été trouvée.</p>';
                    echo '</div>';
                }
