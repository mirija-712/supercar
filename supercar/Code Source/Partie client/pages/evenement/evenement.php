            ...
            <div class="row justify-content-center">
                <div class="col-md-11">
                    <label for="" align="left">
                            ...
                            |   Suivez-nous sur <img src="../../icones/icone_reseau/icons8-facebook-96.png" alt="" height="20px" width="20px" id="footer-image">
                                                <img src="../../icones/icone_reseau/icons8-insta-96.png" alt="" height="20px" width="20px" id="footer-image">
                                                <img src="../../icones/icone_reseau/icons8-twitter-96.png" alt="" height="20px" width="20px" id="footer-image"> | <br>
                    </label>              
                </div>
            </div>
        </div>
