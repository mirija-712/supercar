        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6" id="inscription_main">
                    <form id="forminscription" method="POST" action="fonction_php/inscription.php">
                        <div class="mb-3">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                <button class="btn btn-warning btn-sm" type="submit">S'incrire</button>
                            </div>
                            <div class="col-md-6">
                                <p align="right"><a href="seconnecter.php" class="btn btn-success btn-sm">Se connecter</a></p>
                            </div>
                        </div>
                    </form>
                </div>
