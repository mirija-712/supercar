            ...
            <div class="row justify-content-center">
                <div class="col-md-6" id="inscription_main">
                    <form id="form-connexion" method="POST" action="fonction_php/connexion.php">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                <button class="btn btn-success btn-sm" type="submit">Se connecter</button>
                            </div>
                            <div class="col-md-6">
                                <p align="right"><a href = "inscription_main.php" class="btn btn-danger btn-sm" >S'incrire</a></p>
                            </div>
                        </div>
                    </form>
                </div>
